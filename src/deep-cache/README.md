...
[![NPM Version](https://img.shields.io/npm/v/deep-cache.svg)](https://npmjs.org/package/deep-cache)
...
[![API Docs](http://docs.deep.mg/deep-cache/badge.svg)](http://docs.deep.mg/deep-cache/)

[deep-cache](https://www.npmjs.com/package/deep-cache) is a node.js library, part of [DEEP Framework](https://github.com/MitocGroup/deep-framework).
