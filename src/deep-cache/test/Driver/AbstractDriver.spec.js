...
suite('Driver/AbstractDriver', () => {
  ...
  test('Check constructor sets by default _buildId=""', () => {
    chai.expect(abstractDriver.buildId).to.be.equal('');
  });

  test('Check constructor sets by default _namespace=""', () => {
    chai.expect(abstractDriver.namespace).to.be.equal('');
  });

  test('Check constructor sets by default _silent=""', () => {
    chai.expect(abstractDriver.silent).to.be.equal(false);
  });

  test(`Check buildId setter sets value: ${buildId}`, () => {
  ...
  test(`Check namespace setter sets value: ${namespace}`, () => {
    //check for empty string
  ...
  test(`Check silent setter sets value: ${silent}`, () => {
    //check for empty string
  ...
  test('Check set() method throws exception', () => {
  ...
  test('Check flush() method with valid _flush value', () => {
    let spyCallback = sinon.spy();
