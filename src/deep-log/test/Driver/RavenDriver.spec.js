...
suite('Driver/RavenDriver', () => {
  ...
  test('Class RavenDriver exists in Driver/RavenDriver', () => {
    chai.expect(RavenDriver).to.be.an('function');
  });

  test('Check constructor sets _clients by default', () => {
