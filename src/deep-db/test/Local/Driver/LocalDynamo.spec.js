...
suite('Local/Driver/LocalDynamo', () => {
  //mocking localDynamo
  ...
  test('Class LocalDynamo exists in Local/Driver/LocalDynamo', () => {
    chai.expect(LocalDynamo).to.be.an('function');
  });
  ...
  test('Check constructor sets _process=null', () => {
  ...
  test('Check constructor sets _pickUpOldInstance=true', () => {
  ...
  test('Check constructor sets _pickUpOldInstance', () => {
    chai.expect(localDynamo.pickUpOldInstance).to.be.equal(true);
  });

  test('Check start() method starts LocalDynamo', () => {
  ...
  test('Check stop() method starts LocalDynamo', () => {
    let spyCallback = sinon.spy();
