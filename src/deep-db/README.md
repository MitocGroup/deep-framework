...
[![NPM Version](https://img.shields.io/npm/v/deep-db.svg)](https://npmjs.org/package/deep-db)
...
[![API Docs](http://docs.deep.mg/deep-db/badge.svg)](http://docs.deep.mg/deep-db/)

[deep-db](https://www.npmjs.com/package/deep-db) is a node.js library, part of [DEEP Framework](https://github.com/MitocGroup/deep-framework).
