...
suite('AWS/IAM/Resource', function() {
  ...
  test(`Check region setter throws exception for invalid value: ${invalidRegion}`, function() {
    let error = null;
    try {
  ...
  test(`Check updateFromArn method throws exception for invalid value: ${invalidArn}`, function() {
    let error = null;
    try {
