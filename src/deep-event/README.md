...
[![NPM Version](https://img.shields.io/npm/v/deep-event.svg)](https://npmjs.org/package/deep-event)
...
[![API Docs](http://docs.deep.mg/deep-event/badge.svg)](http://docs.deep.mg/deep-event/)

[deep-event](https://www.npmjs.com/package/deep-event) is a node.js library, part of [DEEP Framework](https://github.com/MitocGroup/deep-framework).
