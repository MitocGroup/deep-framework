...
[![NPM Version](https://img.shields.io/npm/v/deep-di.svg)](https://npmjs.org/package/deep-di)
...
[![API Docs](http://docs.deep.mg/deep-di/badge.svg)](http://docs.deep.mg/deep-di/)

[deep-di](https://www.npmjs.com/package/deep-di) is a node.js library, part of [DEEP Framework](https://github.com/MitocGroup/deep-framework).
